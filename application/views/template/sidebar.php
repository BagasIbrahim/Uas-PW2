<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="http://localhost/UAS/pegawai" class="brand-link">
        <img src="<?php echo base_url() ?>assets/dist/img/AdminLTELogo.png" alt="AdminLTE Logo"
            class="brand-image img-circle elevation-2" style="opacity: 10">
    ...
    <div class="sidebar">
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="#" class="d-block">Lurry Putri Aprilia</a>
            </div>
        </div>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <a href="http://localhost/UAS/pegawai" class="nav-link">
                    <i class="nav-icon fas fa-tachometer-alt"></i>
                    <p>
                        Data pegawai
                        <!-- <i class="right fas fa-angle-left"></i> -->
                ...
                <a href="http://localhost/UAS/pegawai/tampil_grafik" class="nav-link">
